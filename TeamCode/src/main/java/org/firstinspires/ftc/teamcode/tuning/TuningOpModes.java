...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = DriveAuto.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(DriveAuto.class)) {
            dvf = hardwareMap -> {
                DriveAuto md = new DriveAuto(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof DriveAuto.DriveLocalizer) {
                    DriveAuto.DriveLocalizer dl = (DriveAuto.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        DriveAuto.PARAMS.inPerTick,
                        DriveAuto.PARAMS.maxWheelVel,
                        DriveAuto.PARAMS.minProfileAccel,
                        DriveAuto.PARAMS.maxProfileAccel,
                        ...
                        md.imu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(DriveAuto.PARAMS.kS,
                                DriveAuto.PARAMS.kV / DriveAuto.PARAMS.inPerTick,
                                DriveAuto.PARAMS.kA / DriveAuto.PARAMS.inPerTick)
                );
            };
